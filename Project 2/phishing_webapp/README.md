...
```text
phishing_project/
├── IICT_Project_2.ipynb        # Model training & evaluation notebook
├── export_artifacts_cell.py    # Helper script to export trained model & pipeline
└── phishing_webapp/            # Deployment directory
    ...
    └── model_artifacts/        # Generated by export_artifacts_cell.py
